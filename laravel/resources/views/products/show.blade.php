            ...
            <div id="guideCarousel" class="carousel slide guide-detail-gallery" data-bs-ride="carousel">
              <div class="carousel-inner rounded-4 overflow-hidden">
                <div class="carousel-item active">
                  <img src="https://images.unsplash.com/photo-1518509562904-e7ef99cdcc86?auto=format&fit=crop&w=1200&q=80"
                    class="d-block w-100 img-fluid" alt="{{ $product->name }}">
                </div>
                ...
                <div class="carousel-item">
                  <img src="https://images.unsplash.com/photo-1537953773345-d172ccf13cf1?auto=format&fit=crop&w=1200&q=80"
                    class="d-block w-100 img-fluid" alt="{{ $product->name }}">
                </div>
              </div>
